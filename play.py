...
def play(printGame = True):
    ...
    player1 = decisionTreeAI.DecisionTreeAI("Player 1", chess.WHITE, depth = 1, random= False)
    player2 = decisionTreeAI.DecisionTreeAI("Player 2", chess.BLACK, depth = 1, random = True)
